...
username = "your_email@example.com"       # Enter your username in the quotes
...
deepseek_api_key = "your_deepseek_api_key_here"                # Enter your DeepSeek API key in the quotes
'''
...
llm_api_key = "your_api_key_here"              # Enter your API key in the quotes, make sure it's valid, if not will result in error.
'''
...
llm_model = "gpt-4o"          # Examples: "gpt-3.5-turbo", "gpt-4o", "llama-3.2-3b-instruct"
